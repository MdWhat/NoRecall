...
- (void)fillSendOnlyCmd:(struct CNetCmd *)arg1 withCgi:(id)arg2;
- (void)fillCgiCmd:(struct CNetCmd *)arg1 withCgi:(id)arg2;
- (unsigned int)GetUin;
- (id)GetSessionKey;
- (void)eraseSessionIdInDelegate:(id)arg1 sessionId:(unsigned int)arg2;
- (void)eraseDelegate:(id)arg1 sessionIdSet:(set_55031187 *)arg2;
